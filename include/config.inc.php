...
define("HEADER_QTH","Mobile");
define("HEADER_QRG","145.7875 MHz");
define("HEADER_SYSOP","Sysop: DD5RW");
...
define("KEY2", array(' TG262907 ','*91262907#','orange'));
define("KEY3", array(' TG7 ','*917#','orange'));
define("KEY4", array(' TG24 ','*9124#','orange'));
define("KEY5", array(' TG777', '*91777#','orange'));
define("KEY6", array(' TG2620 ','*912620#','orange'));
define("KEY7", array(' TG2621 ','*912621#','orange'));
define("KEY8", array(' TG2629 ','*912629#','orange'));
define("KEY9", array(' TG14774 ','*9114774#','orange'));
define("KEY10", array(' Refl. OFF ','*D0#','red'));
// additional DTMF keys
define("KEY11", array(' Papagei ','*D11#','green'));
define("KEY12", array(' Echolink ','*D12#','orange'));
define("KEY13", array(' DB0TUD ','*D13#','orange'));
...
define("KEY19", array(' TG20 ','*9120#','blue'));
define("KEY20", array(' # ','*D20#','red'));
...
define("FMNETWORK","FM-Funknetz.de");
...
define("HOSTS","https://status.thueringen.link");
