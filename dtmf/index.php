...
// Defined buttons:
    ...
    {
        shell_exec('echo "*91260#" > ' . $dtmfctrl );
    }

   if (isset($_POST['button2']))
    {
        shell_exec('echo "*912600#" > ' . $dtmfctrl );
    }

 if (isset($_POST['button3']))
    {
        shell_exec('echo "*9126078#" > ' . $dtmfctrl );
    }

 if (isset($_POST['button4']))
    {
        shell_exec('echo "*91999#" > ' . $dtmfctrl );
    }

 if (isset($_POST['button5']))
    {
        shell_exec('echo "9191#" > ' . $dtmfctrl );
    }

 if (isset($_POST['button6']))
    {
        shell_exec('echo "9126021#" > ' . $dtmfctrl );
    }

 if (isset($_POST['button7']))
    {
        shell_exec('echo "9126062#" > ' . $dtmfctrl );
    }

 if (isset($_POST['button8']))
    {
        shell_exec('echo "910#" > ' . $dtmfctrl );
    }

if (isset($_POST['button9']))
    {
        shell_exec('echo "*#" > ' . $dtmfctrl );
    }

 if (isset($_POST['button10']))
    {
        shell_exec('echo "*1#" > ' . $dtmfctrl );
    }

 if (isset($_POST['button11']))
    {
        shell_exec('echo "*2# 453582#" > ' . $dtmfctrl );
    }

 if (isset($_POST['button12']))
    {
        shell_exec('echo "2# 871657## " > ' . $dtmfctrl );
    }
...
if (isset($_POST['buttonAA']))
    {
        shell_exec('echo "A" > ' . $dtmfctrl );
     //   echo '<pre><h1><center><p style="color: #454545; ">Send DTMF: #</center></h1></p></pre$    }
}
if (isset($_POST['buttonBB']))
    {
        shell_exec('echo "B" > ' . $dtmfctrl );
     //   echo '<pre><h1><center><p style="color: #454545; ">Send DTMF: #</center></h1></p></pre$    }
}

if (isset($_POST['buttonCC']))
    {
        shell_exec('echo "C" > ' . $dtmfctrl );
     //   echo '<pre><h1><center><p style="color: #454545; ">Send DTMF: #</center></h1></p></pre$    }
}

if (isset($_POST['buttonDD']))
    {
        shell_exec('echo "D" > ' . $dtmfctrl );
     //   echo '<pre><h1><center><p style="color: #454545; ">Send DTMF: #</center></h1></p></pre$    }
}
